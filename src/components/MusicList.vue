<template>
  <div class="music-list">
    <div class="list-item" v-for="(item, index) in musicLists" v-show="!partLoading" :key="item">
      ...
      <div class="info" @click="_play(item)">
        <div class="music-name">{{item.name}}
    ...
    <s-loading v-show="partLoading"></s-loading>
  </div>
</template>
